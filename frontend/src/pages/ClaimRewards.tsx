...
const ClaimRewards: React.FC = () => {
  const { pendingRewards, claimReward, loading, error } = useApiData();
  ...
  const handleClaim = async (rewardId: string) => {
    ...
    try {
      const voucher = await claimReward(rewardId);
      console.log('Claim voucher:', voucher);
      // In a real app, you would submit this voucher to the smart contract
